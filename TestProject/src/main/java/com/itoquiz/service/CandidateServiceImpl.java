...
public class CandidateServiceImpl {
	...
	public CandidateServiceImpl(QuizRepository quizRepository, CandidateRepository candidateRepository) { // Injecting
																											// Repository
																											// in
																											// Service																									// Layer
	...
	public Candidate findCandidateById(int n) {

		return candidateRepository.findById(n).orElseThrow(() -> new ResourceNotFoundException("candidate", "Id", n));
	}

	// ***************************************** Methods related to Cadidate
